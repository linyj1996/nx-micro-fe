...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/NO1NBENWXp)
...
```sh
npx nx serve nx-micro-fe
```

To create a production bundle:

```sh
npx nx build nx-micro-fe
```

To see all available targets to run for a project, run:

```sh
npx nx show project nx-micro-fe
```
